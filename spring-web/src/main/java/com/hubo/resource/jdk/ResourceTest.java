package com.hubo.resource.jdk;

public class ResourceTest {
	public static void main(String[] args) {
		// 1.通过class的getResource方法
		String a1 = ResourceTest.class.getResource("/com/hubo/resource/jdk/Resource.class").getPath();
		...
		String b1 = ResourceTest.class.getClassLoader().getResource("com/hubo/resource/jdk/Resource.class").getPath();
		...
		String c1 = ClassLoader.getSystemClassLoader().getResource("com/hubo/resource/jdk/Resource.class").getPath();
		...
		String d1 = ClassLoader.getSystemResource("com/hubo/resource/jdk/Resource.class").getPath();
		...
		String e1 = Thread.currentThread().getContextClassLoader().getResource("com/hubo/resource/jdk/Resource.class")
				.getPath();
